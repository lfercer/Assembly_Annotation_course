...
dat <- fread("/data/users/lfernandez/assembly_course/annotation_evaluation/genespace/orthofinder/Results_Nov14/Comparative_Genomics_Statistics/Statistics_PerSpecies.tsv", header = T, fill = TRUE)
...
orthogroups <- fread("/data/users/lfernandez/assembly_course/annotation_evaluation/genespace/orthofinder/Results_Nov14/Orthogroups/Orthogroups.GeneCount.tsv")
